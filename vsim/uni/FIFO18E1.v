...
endgenerate
	...
	if (FIFO_SIZE == 18)
	    case (DATA_WIDTH)
		4 : WRCOUNT = {1'b1, wr_addr[11:0]};
		9 : WRCOUNT = {2'b11, wr_addr[10:0]};
		18 : WRCOUNT = {3'b111, wr_addr[9:0]};
		36 : WRCOUNT = {4'hf, wr_addr[8:0]};
		default : WRCOUNT = wr_addr;
	    endcase // case(DATA_WIDTH)
	else
	    case (DATA_WIDTH)
		4 : WRCOUNT = wr_addr;
		9 : WRCOUNT = {1'b1, wr_addr[11:0]};
		18 : WRCOUNT = {2'b11, wr_addr[10:0]};
		36 : WRCOUNT = {3'b111, wr_addr[9:0]};
		72 : WRCOUNT = {4'hf, wr_addr[8:0]};
		default : WRCOUNT = wr_addr;
	    endcase // case(DATA_WIDTH)
	...
	if (FIFO_SIZE == 18)
	    case (DATA_WIDTH)
		4 : RDCOUNT = {1'b1, rdcount_out[11:0]};
		9 : RDCOUNT = {2'b11, rdcount_out[10:0]};
		18 : RDCOUNT = {3'b111, rdcount_out[9:0]};
		36 : RDCOUNT = {4'hf, rdcount_out[8:0]};
		default : RDCOUNT = rdcount_out;
	    endcase // case(DATA_WIDTH)
	else
	    case (DATA_WIDTH)
		4 : RDCOUNT = rdcount_out;
		9 : RDCOUNT = {1'b1, rdcount_out[11:0]};
		18 : RDCOUNT = {2'b11, rdcount_out[10:0]};
		36 : RDCOUNT = {3'b111, rdcount_out[9:0]};
		72 : RDCOUNT = {4'hf, rdcount_out[8:0]};
		default : RDCOUNT = rdcount_out;
	    endcase // case(DATA_WIDTH)
